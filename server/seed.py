...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        beginner_yoga = Event(name="Beginner Yoga Event", price=15, category="Yoga", capacity=20, hours=1, minutes=0, description="Entry level yoga class for beginners or more experienced yogis who want a more mellow session.  Free for members.", stripe_product_id="prod_NxgnBE0sOFrH4K", stripe_price_id="price_1NBlPhBoM5Q6sMKnuL9YMa66")
        intermediate_yoga = Event(name="Intemediate Yoga Event", price=15, category="Yoga", capacity=20, hours=1, minutes=0, description="Intemediate level yoga class for slightly to well experienced yogis.  Free for members.", stripe_product_id="prod_NxgnBE0sOFrH4K", stripe_price_id="price_1NBlPhBoM5Q6sMKnuL9YMa66")
        advanced_yoga = Event(name="Advanced Yoga Event", category="Yoga", capacity=20, hours=1, minutes=0, price=15, description="Advanced level yoga class for experienced yogis.  Beginners not advised.  Free for members.", stripe_product_id="prod_NxgnBE0sOFrH4K", stripe_price_id="price_1NBlPhBoM5Q6sMKnuL9YMa66")

        core_class = Event(name="Core Event", price=10, category="Fitness", capacity=20, hours=0, minutes=30, description="30 minute long intense core workout lead by experienced instructor.  Get ready to feel the burn!", stripe_product_id="prod_NxgnNhpVFsYVwS", stripe_price_id="price_1NBlPhBoM5Q6sMKn1ua2lXDS")
        
        flexibility_class = Event(name="Flexibility Friday", price=10, category="Fitness", capacity=20, hours=0, minutes=30, description="Work on your flexibility regardless of your current level!", stripe_product_id="prod_NxgnNhpVFsYVwS", stripe_price_id="price_1NBlPhBoM5Q6sMKn1ua2lXDS")
